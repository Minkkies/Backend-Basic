...
## Repository ที่เกี่ยวข้อง (ควรที่จะไปดูอันนี้มาก่อน)
- [Javascript101](https://github.com/Minkkies/Javascript101) - เนื้อหา JavaScript พื้นฐาน
...
ก่อนจะไปเรียนรู้ Node.js ให้รู้จัก การส่งข้อมูลของ json ก่อนไปอ่านได้ที่ไฟล์ [JsonBasic](JsonBasic.md)
